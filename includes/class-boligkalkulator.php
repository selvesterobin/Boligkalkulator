...
class Boligkalkulator {
    ...
    public function sanitize_settings( $settings ) {
        ...
        return array(
            ...
            'bank_repayment_help'        => isset( $settings['bank_repayment_help'] ) ? sanitize_textarea_field( $settings['bank_repayment_help'] ) : '',
            'budget_intro_text'          => isset( $settings['budget_intro_text'] ) ? sanitize_textarea_field( $settings['budget_intro_text'] ) : 'Nedenfor har vi estimert månedlige utgifter for en bolig med Boligspleis og sammenlignet med ordinært kjøp av samme bolig og 10% oppspart egenkapital. Budsjettet er basert på oppgitte informasjon i steg 1 og 2 om kjøpesum, finansiering og ønsket eierandel. I tillegg har vi estimert renter og avdrag på lån og fellesgjeld, samt leiebeløp til OsloBolig og fellesutgifter for boligen',
